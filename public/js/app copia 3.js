document.addEventListener("DOMContentLoaded", function () {
  ...
  window.i18n = {
    ...
    en: {
      ...
      hero_subtitle: "Heritage Houses of Korčula’s Noble Families",
      hero_cta: "Explore the collection",
      hero_scroll: "Discover",
      about_eyebrow: "Our Philosophy",
      about_title_1: "Case dei",
      about_title_2: "Nobili",
      about_text1:
        "Within the medieval walls of Korčula, Case dei Nobili is a private collection of restored Gothic and Renaissance residences once linked to the island’s noble families. Carefully revived with deep respect for their architectural heritage, each home preserves the spirit of centuries past while offering the comfort, discretion and refinement expected by today’s discerning traveler.",
      about_text2:
        "Historic stonework, noble proportions and curated antiques meet underfloor heating, air conditioning, premium linens, elegant bathrooms and modern technology. Located only moments from the Cathedral of St. Mark and the waterfront, these residences invite guests to experience the Adriatic not as visitors, but as temporary residents of history.",
      about_text3:
        "Case dei Nobili is not a hotel. It is a rare collection of private homes for those who value authenticity, beauty and a true sense of place.",
