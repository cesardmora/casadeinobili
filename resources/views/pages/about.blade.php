...
@section('title', 'About | Case dei Nobili')
@section('meta_description', 'Learn the history and team behind Case dei Nobili — a private collection of historic residences in Korčula, Croatia.')
...
@section('content')
  ...
  <section class="hero-section">
      ...
      <div class="max-w-7xl mx-auto w-full">
        <div class="max-w-3xl">
          ...
          <h1 class="font-display text-5xl md:text-7xl lg:text-8xl font-light leading-tight mb-8"
            ...
            <span data-i18n="about_title_1">Preserve to</span><br>
            <em style="color: var(--patina-light);" data-i18n="about_title_2">inhabit</em>
          </h1>
          <p class="text-lg font-light leading-relaxed max-w-xl"
             style="color: var(--stone); opacity: 0.8;"
             data-i18n="about_text1">
            Every restoration is an act of reverence. We work with local artisans, using centuries-old techniques and island materials, so each house maintains its authentic soul.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="absolute bottom-12 left-1/2 transform -translate-x-1/2 z-10">
      <div class="flex flex-col items-center gap-4 opacity-50">
        <span class="text-xs tracking-widest uppercase" style="color: var(--stone);">Discover</span>
  ...
  <section class="py-24 lg:py-40 px-6 lg:px-12" style="background: var(--stone-light);">
    <div class="max-w-7xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div class="reveal">
          <p class="text-xs tracking-widest uppercase mb-6" style="color: var(--patina);">About Us</p>
          <h2 class="font-display text-4xl md:text-5xl font-light leading-tight mb-8" style="color: var(--ink);">
            Through TCG Unique<br>
            <em class="italic" style="color: var(--adriatic);">Properties d.o.o.</em>
          </h2>
  ...
  <section class="py-24 lg:py-40 px-6 lg:px-12" style="background: var(--stone-light);">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-16 reveal">
        <p class="text-xs tracking-widest uppercase mb-4" style="color: var(--patina);">Team</p>
        <h2 class="font-display text-4xl md:text-5xl font-light" style="color: var(--ink);">
          The <em class="italic" style="color: var(--adriatic);">Team</em>
        </h2>
      </div>
    ...
    <div class="max-w-7xl mx-auto relative z-10">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        <div class="reveal">
          ...
          <p class="text-xs tracking-widest uppercase" style="color: var(--stone); opacity: 0.6;">Residences</p>
        </div>
        <div class="reveal reveal-delay-1">
          <p class="font-display text-5xl lg:text-7xl font-light mb-2" style="color: var(--patina-light);">V</p>
          <p class="text-xs tracking-widest uppercase" style="color: var(--stone); opacity: 0.6;">Centuries of History</p>
        </div>
        <div class="reveal reveal-delay-2">
          <p class="font-display text-5xl lg:text-7xl font-light mb-2" style="color: var(--patina-light);">+10</p>
          <p class="text-xs tracking-widest uppercase" style="color: var(--stone); opacity: 0.6;">Years of Restoration</p>
        </div>
        <div class="reveal reveal-delay-3">
          <p class="font-display text-5xl lg:text-7xl font-light mb-2" style="color: var(--patina-light);">1</p>
          <p class="text-xs tracking-widest uppercase" style="color: var(--stone); opacity: 0.6;">Unique Island</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 px-6 text-center" style="background: var(--stone-light);">
    <div class="max-w-2xl mx-auto reveal">
      <p class="text-xs tracking-widest uppercase mb-6" style="color: var(--patina);">Ready to step into history?</p>
      <h2 class="font-display text-4xl md:text-5xl font-light mb-8" style="color: var(--ink);">
        Explore the <em class="italic" style="color: var(--adriatic);">collection</em>
      </h2>
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="{{ route('home') }}#collection" class="btn-editorial inline-block">
          View properties
        </a>
