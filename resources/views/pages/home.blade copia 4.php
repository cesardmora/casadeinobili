  ...
  {{-- <section class="py-24 lg:py-40 px-6 lg:px-12" style="background: var(--stone-light);">
    <div class="max-w-7xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div class="reveal">
          <p class="text-xs tracking-widest uppercase mb-6" style="color: var(--patina);">Case dei Nobili</p>
          <h2 class="font-display text-4xl md:text-5xl lg:text-6xl font-light leading-tight mb-8" style="color: var(--ink);">
            Casas patrimoniales de las familias nobles de <br>
            <em class="italic" style="color: var(--adriatic);">Korčula</em>
          </h2>
        ...
        <div class="reveal reveal-delay-2">
          <p class="text-base lg:text-lg font-light leading-relaxed mb-6" style="color: var(--ink-soft);">
            Case dei Nobili es una colección seleccionada de residencias góticas, renacentistas e históricas, cuidadosamente recuperadas con antigüedades refinadas, confort contemporáneo y un singular sentido del lugar, a solo unos pasos de la Catedral.
          </p>
      ...
      <div class="flex flex-col justify-center order-1 lg:order-2">
        ...
        <div class="reveal reveal-delay-3 grid grid-cols-3 gap-8 mt-8">
          ...
          <div class="mt-16 reveal reveal-delay-4 visible">
            <a href="{{ route('about') }}" class="btn-editorial-2 inline-block" data-i18n="nav_about">Nosotros</a>
          </div>
      </div>
