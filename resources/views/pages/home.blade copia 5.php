...
@section('content')
        ...
        <div class="reveal">
          ...
          <h2 class="font-display text-4xl md:text-5xl font-light leading-tight mb-8" style="color: var(--stone);">
            ...
            <em class="italic" style="color: var(--stone-light);"
                data-i18n="about_title_2">Inhabit</em>
          </h2>
        </div>
        ...
        <div class="reveal reveal-delay-2">
          ...
          <p class="text-base lg:text-lg font-light leading-relaxed mb-6" style="color: var(--stone);"
            data-i18n="about_text1">
             Each restoration is an act of reverence. We work with local artisans, using centuries-old techniques and island materials, so that every house keeps its soul intact.
          </p>
          <p class="text-base lg:text-lg font-light leading-relaxed mb-8" style="color: var(--stone);"
            data-i18n="about_text2">
             We do not create spaces for tourists. We create homes for travelers seeking to inhabit history, if only for a few days.
          </p>
        </div>
  ...
  <section id="contacto" class="py-24 lg:py-32 px-6 lg:px-12" style="background: var(--dark);">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 mb-16">
        ...
        {{-- Contact info --}}
        <div class="reveal">
          <p class="text-xs tracking-widest uppercase mb-6" style="color: var(--patina);">Contact</p>
          <h2 class="font-display text-4xl md:text-5xl font-light mb-8" style="color: var(--stone-light);">
            Begin your<br>
            <em class="italic" style="color: var(--patina-light);">story</em>
          </h2>
          <p class="text-base font-light mb-8 max-w-md" style="color: var(--stone); opacity: 0.6;">
            Every booking is a conversation. Tell us about your journey and we will help you find the perfect house for your stay in Korčula.
          </p>
          <div class="space-y-4">
        ...
        {{-- Newsletter --}}
        <div class="reveal reveal-delay-2">
          <p class="text-xs tracking-widest uppercase mb-6" style="color: var(--patina);">Newsletter</p>
          ...
          <p class="text-sm font-light mb-8" style="color: var(--stone); opacity: 0.6;">
            Receive chronicles from Korčula, collection updates, and exclusive offers before anyone else.
          </p>
