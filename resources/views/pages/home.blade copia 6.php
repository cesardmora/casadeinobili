...
@section('content')
  ...
  <section class="hero-section">
    ...
    <img
      src="{{ asset('images/korcula_01.jpg') }}"
      alt="Case dei Nobili"
    ...
    <div class="relative z-10 h-full flex flex-col justify-center px-6 lg:px-12">
      <div class="max-w-7xl mx-auto w-full text-center">
        <div class="max-w-12xl">
          ...
          <p class="text-lg md:text-xl font-light leading-relaxed mb-12 max-w-12xl"
            style="color: var(--stone)"
            data-i18n="hero_subtitle">
            Four historic residences on the island of Korčula. Each one, a livable chapter of Dalmatian history.
          </p>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mt-10">
          ...
          <a href="#bodas"
            class="inline-block px-10 py-4 text-xs tracking-widest uppercase border transition-colors duration-300"
            style="border-color: rgba(184,149,107,0.5); color: var(--stone-light);"
            onmouseover="this.style.background='rgba(184,149,107,0.15)'"
      ...
      <div class="grid lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div class="reveal order-2 lg:order-1">
          <div class="relative aspect-[4/5]">
            <img
               src="{{ asset('images/korcula_CityEntry.jpg') }}"
  ...
  {{-- ===================== INTRO / OUR STORY ===================== --}}
  <section id="nosotros" class="py-24 lg:py-40 px-6 lg:px-12 relative overflow-hidden" style="background: var(--ink);">
  ...
  {{-- ===================== COLLECTION ===================== --}}
  <section id="coleccion" class="py-24 lg:py-32 px-6 lg:px-12" style="background: var(--dark);">
  ...
  {{-- <section id="bodasOk" class="private-section py-24 lg:py-40 px-6 lg:px-12">
    <div class="max-w-7xl mx-auto relative z-10">
      ...
      <div class="text-center mt-16 reveal reveal-delay-4">
        ...
        <a href="#contacto" class="btn-editorial inline-block">Request Dossier</a>
      </div>

    </div>
  </section> --}}

  <section id="bodas" class="py-24 lg:py-40 px-6 lg:px-12 relative overflow-hidden" style="background: var(--adriatic-deep);">
      ...
      <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div class="reveal order-2 lg:order-1">
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="relative overflow-hidden row-span-2" style="height: 520px;">
              <img
  ...
  {{-- <section id="isla" class="py-24 lg:py-40 px-6 lg:px-12" style="background: var(--ink);">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="reveal overflow-hidden w-full" style="height: 300px;">
        <img
          src="{{ asset('images/korcula_02.jpg') }}"
          alt="Korčula"
          class="w-full h-full object-cover"
          loading="lazy"
  ...
  {{-- ===================== ISLA 2 — PANELS ===================== --}}
  <section id="isla" class="py-24 lg:py-32 px-6 lg:px-12" style="background: var(--adriatic);">
    <div class="max-w-12xl mx-auto">
      ...
      <div class="grid md:grid-cols-3 gap-0 reveal">
        ...
        {{-- Panel 1 — History --}}
        <div class="relative overflow-hidden" style="height: 520px;">
          <div class="absolute inset-0 bg-cover bg-center transition-transform duration-700 hover:scale-105"
               style="background-image: url('https://images.unsplash.com/photo-1555990793-da11153b2473?w=900&q=80');"></div>
          <div class="absolute inset-0" style="background: linear-gradient(to top, rgba(13,31,40,0.85) 40%, rgba(13,31,40,0.2) 100%);"></div>
        ...
        <div class="relative overflow-hidden" style="height: 520px;">
          <div class="absolute inset-0 bg-cover bg-center transition-transform duration-700 hover:scale-105"
               style="background-image: url('https://images.unsplash.com/photo-1546484396-fb3fc6f95f98?w=900&q=80');"></div>
          <div class="absolute inset-0" style="background: linear-gradient(to top, rgba(13,31,40,0.85) 40%, rgba(13,31,40,0.2) 100%);"></div>
          <div class="absolute inset-0 flex flex-col justify-end p-8 lg:p-10">
            <div class="text-3xl mb-4">🍷</div>
            <h3 class="font-display text-2xl font-light mb-3" style="color: var(--stone-light);"
        ...
        <div class="relative overflow-hidden" style="height: 520px;">
          <div class="absolute inset-0 bg-cover bg-center transition-transform duration-700 hover:scale-105"
               style="background-image: url('https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=900&q=80');"></div>
          <div class="absolute inset-0" style="background: linear-gradient(to top, rgba(13,31,40,0.85) 40%, rgba(13,31,40,0.2) 100%);"></div>
          <div class="absolute inset-0 flex flex-col justify-end p-8 lg:p-10">
            <div class="text-3xl mb-4">⛵</div>
            <h3 class="font-display text-2xl font-light mb-3" style="color: var(--stone-light);"
  ...
  <!-- SIMPLE CONTACT -->
  <section id="contacto" class="py-32 lg:py-40 px-6 lg:px-12" style="background: var(--ink);">
