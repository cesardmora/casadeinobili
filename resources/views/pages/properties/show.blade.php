...
@section('content')
  ...
  <section class="py-24 lg:py-40 px-6 lg:px-12" style="background: var(--stone-light);">
    <div class="max-w-7xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div class="reveal">
          <p class="text-xs tracking-widest uppercase mb-6" style="color: var(--patina);">The Property</p>
  ...
  @if($property->gallery_images && count($property->gallery_images) > 1)
    <section class="py-12 px-6 lg:px-12" style="background: var(--stone);">
      <div class="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        @foreach($property->gallery_images as $img)
          <div class="aspect-[4/3] overflow-hidden reveal">
            <img src="{{ $img }}" alt="{{ $property->name }}" class="w-full h-full object-cover property-image" loading="lazy">
          </div>
        @endforeach
      </div>
    </section>
